...
def bundle_comprovante(paciente, profissional_executante, profissional_solicitante, local, agendamento):
    return {
        "resourceType": "Bundle",
        "type": "collection",
        "entry": [
            {"resource": paciente_para_fhir(paciente)},
            {"resource": profissional_para_fhir(profissional_solicitante)},
            {"resource": profissional_para_fhir(profissional_executante)},
